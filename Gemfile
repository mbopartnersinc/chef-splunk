...
# These gems have been pinned specifically for chef-dk 0.16.28.
# https://github.com/chef/chef-dk/blob/d6ed42d4131e847a9ddd95fcff2406983cb426e1/Gemfile.lock
...
group :integration do
  ...
  gem 'ffi-win32-extensions', '= 1.0.2'
  gem 'ffi-yajl', '= 2.2.3'
  gem 'fission', '= 0.5.0'
  gem 'fog', '= 1.38.0'
